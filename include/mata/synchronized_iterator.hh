...
namespace Mata {
    namespace Util {
        ...
        public:
            ...
            explicit synchronized_iterator(const int size = 0)
            {
        ...
        class synchronized_univerzal_iterator: public synchronized_iterator<Key> {
        public:
            ...
            explicit synchronized_univerzal_iterator(const int size=0) : synchronized_iterator<Key>(size) {};

            void reset(const int size = 0) {
                synchronized_iterator<Key>::reset(size);
        ...
        template<typename Key>
        class synchronized_existential_iterator : public synchronized_iterator<Key> {
        public:
            ...
            explicit synchronized_existential_iterator(const int size=0) : synchronized_iterator<Key>(size)
            {
