...
bool mata::nft::algorithms::is_universal_naive(const Nft& aut, const Alphabet& alphabet,
											   Run* cex) { // {{{
...
bool mata::nft::algorithms::is_universal_antichains(const Nft& aut, const Alphabet& alphabet,
													Run* cex) { // {{{
