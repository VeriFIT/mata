...
namespace {
    ...
    AlgoType set_algorithm(const std::string &function_name, const std::unordered_map<std::string, std::string> &params) {
...
bool Mata::Nfa::are_equivalent(const Nfa& lhs, const Nfa& rhs, const Alphabet *alphabet, const std::unordered_map<std::string, std::string>& params)
{
...
bool Mata::Nfa::are_equivalent(const Nfa& lhs, const Nfa& rhs, const std::unordered_map<std::string, std::string>& params) {
