...
cdef extern from "mata/nfa.hh" namespace "Mata::Nfa":
    ...
    cdef bool is_incl(CNfa&, CNfa&, Word*, CAlphabet*, StringMap&) except +
    ...
    cdef void complement(CNfa*, CNfa&, CAlphabet&, StringMap&, SubsetMap*) except +
