...
def create_identity_with_single_symbol_replace(
    alphabet: alph.Alphabet, from_symbol: Symbol, replacement: Symbol | list[Symbol], replace_mode: ReplaceMode = ReplaceMode.All
) -> mata_nft.Nft:
...
def replace_reluctant_single_symbol(
    from_symbol: Symbol, replacement: Symbol | list[Symbol], alphabet: alph.Alphabet, replace_mode: ReplaceMode = ReplaceMode.All
) -> mata_nft.Nft:
