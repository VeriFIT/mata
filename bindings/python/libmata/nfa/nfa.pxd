...
cdef extern from "mata/nfa/nfa.hh" namespace "Mata::Nfa":
    ...
    cdef bool c_is_universal "Mata::Nfa::is_universal" (CNfa&, CAlphabet&, umap[string, string]&) except +
    cdef bool c_is_included "Mata::Nfa::is_included" (CNfa&, CNfa&, CAlphabet*, umap[string, string]&)
    cdef bool c_is_included "Mata::Nfa::is_included" (CNfa&, CNfa&, CRun*, CAlphabet*, umap[string, string]&) except +
    cdef bool c_are_equivalent "Mata::Nfa::are_equivalent" (CNfa&, CNfa&, CAlphabet*, umap[string, string]&)
    cdef bool c_are_equivalent "Mata::Nfa::are_equivalent" (CNfa&, CNfa&, umap[string, string]&)
    ...
    cdef CRun c_encode_word "Mata::Nfa::encode_word" (umap[string, Symbol]&, vector[string])

cdef extern from "mata/nfa/algorithms.hh" namespace "Mata::Nfa::Algorithms":
    cdef CBinaryRelation& c_compute_relation "Mata::Nfa::Algorithms::compute_relation" (CNfa&, umap[string, string]&)
...
cdef extern from "mata/nfa/plumbing.hh" namespace "Mata::Nfa::Plumbing":
    ...
    cdef void c_concatenate "Mata::Nfa::Plumbing::concatenate" (CNfa*, CNfa&, CNfa&, bool, umap[State, State]*, umap[State, State]*)
    cdef void c_complement "Mata::Nfa::Plumbing::complement" (CNfa*, CNfa&, CAlphabet&, umap[string, string]&) except +
    ...
    cdef void c_reduce "Mata::Nfa::Plumbing::reduce" (CNfa*, CNfa&, bool, umap[State, State]*, umap[string, string]&)
