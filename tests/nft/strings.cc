...
TEST_CASE("nft::reluctant_replacement()") {
    ...
    SECTION("nft::begin_marker_dft() regex cb+a+") {
        nfa::Nfa dfa_begin_marker{ begin_marker_dfa("cb+a+", &alphabet) };
        nfa::Nfa dfa_expected{ nfa::Delta{}, { 0 }, { 0, 1, 2, 4 }};
        dfa_expected.delta.add(0, 'a', 0);
        dfa_expected.delta.add(0, 'b', 0);
        dfa_expected.delta.add(1, 'c', 0);
        dfa_expected.delta.add(0, 'a', 1);
        dfa_expected.delta.add(2, 'b', 1);
        dfa_expected.delta.add(1, 'c', 1);
        dfa_expected.delta.add(3, 'a', 2);
        dfa_expected.delta.add(2, 'b', 2);
        dfa_expected.delta.add(1, 'c', 2);
        dfa_expected.delta.add(4, EPSILON, 3);
        dfa_expected.delta.add(3, 'a', 4);
        dfa_expected.delta.add(0, 'b', 4);
        dfa_expected.delta.add(1, 'c', 4);
        CHECK(nfa::are_equivalent(dfa_begin_marker, dfa_expected));

        Nft dft_begin_marker{ begin_marker_dft(dfa_begin_marker, MARKER) };
        Nft dft_expected{};
        dft_expected.initial.insert(0);
        dft_expected.final.insert(1);
        dft_expected.levels_cnt = 2;
        dft_expected.delta.add(0, EPSILON, 1);
        dft_expected.delta.add(0, EPSILON, 2);
        dft_expected.delta.add(0, EPSILON, 3);
        dft_expected.delta.add(0, EPSILON, 5);
        dft_expected.delta.add(1, 'a', 6);
        dft_expected.delta.add(6, 'a', 1);
        dft_expected.delta.add(6, 'a', 2);
        dft_expected.delta.add(1, 'b', 7);
        dft_expected.delta.add(7, 'b', 1);
        dft_expected.delta.add(7, 'b', 5);
        dft_expected.delta.add(2, 'c', 8);
        dft_expected.delta.add(8, 'c', 2);
        dft_expected.delta.add(8, 'c', 1);
        dft_expected.delta.add(8, 'c', 3);
        dft_expected.delta.add(8, 'c', 5);
        dft_expected.delta.add(3, 'b', 9);
        dft_expected.delta.add(9, 'b', 3);
        dft_expected.delta.add(9, 'b', 2);
        dft_expected.delta.add(4, 'a', 10);
        dft_expected.delta.add(10, 'a', 3);
        dft_expected.delta.add(10, 'a', 5);
        dft_expected.delta.add(5, EPSILON, 11);
        dft_expected.delta.add(11, MARKER, 4);
        dft_expected.levels.resize(12);
        dft_expected.levels[0] = 0;
        dft_expected.levels[1] = 0;
        dft_expected.levels[2] = 0;
        dft_expected.levels[3] = 0;
        dft_expected.levels[4] = 0;
        dft_expected.levels[5] = 0;
        dft_expected.levels[6] = 1;
        dft_expected.levels[7] = 1;
        dft_expected.levels[8] = 1;
        dft_expected.levels[9] = 1;
        dft_expected.levels[10] = 1;
        dft_expected.levels[11] = 1;
        CHECK(nft::are_equivalent(dft_begin_marker, dft_expected));
    }

    SECTION("nft::begin_marker_dft() regex ab+a+") {
        nfa::Nfa dfa_begin_marker{ begin_marker_dfa("ab+a+", &alphabet) };
        nfa::Nfa dfa_expected{ nfa::Delta{}, { 0 }, { 0, 1, 2, 4 }};
        dfa_expected.delta.add(1, 'a', 0);
        dfa_expected.delta.add(0, 'b', 0);
        dfa_expected.delta.add(0, 'c', 0);
        ...
        dfa_expected.delta.add(3, 'a', 2);
        dfa_expected.delta.add(2, 'b', 2);
        dfa_expected.delta.add(0, 'c', 2);
        dfa_expected.delta.add(4, EPSILON, 3);
        dfa_expected.delta.add(3, 'a', 4);
        dfa_expected.delta.add(2, 'b', 4);
        dfa_expected.delta.add(0, 'c', 4);
        CHECK(nfa::are_equivalent(dfa_begin_marker, dfa_expected));

        Nft dft_generic_end_marker{ end_marker_dft(dfa_begin_marker, MARKER) };
        Nft dft_expected{};
        dft_expected.initial.insert(0);
        dft_expected.final = { 0, 2, 7, 14};
        dft_expected.levels_cnt = 2;
