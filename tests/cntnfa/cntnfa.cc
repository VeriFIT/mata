...
TEST_CASE("mata::cntnfa::Trans::operator<<") {
...
{ // {{{
    ...
    {
        parsec.type = cntnfa::TYPE_CNTNFA;
...
{ // {{{
    ...
    SECTION("construct - final states given as true")
    {
        ...
        cntnfa::builder::NameStateMap state_map;
...
TEST_CASE("mata::cntnfa::union_inplace") {
    Run one{{1},{}};
    Run zero{{0}, {}};
...
TEST_CASE("mata::cntnfa::union_product()") {
    Run one{ { 1 },{} };
    Run zero{{ 0 }, {} };
    Run two{ { 2 },{} };
    Run two_three{ { 2, 3 },{} };
