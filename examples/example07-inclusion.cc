...
#define RUN_EXAMPLE(smaller, bigger) do{\
    ...
    std::cout << "Boost bit vectors: " << antichain_boost_test(smaller, bigger, nullptr) << std::endl;\
    std::cout << "Opposite" << std::endl;\
    std::cout << "Ord vectors: " << is_included(bigger, smaller, nullptr, nullptr) << std::endl;\
    std::cout << "Boost bit vectors: " << antichain_boost_test(bigger, smaller, nullptr) << std::endl;\
    std::cout << "\n\n";\
} while(0);
