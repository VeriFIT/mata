...
- Michal Šedý ([koniksedy](https://github.com/koniksedy/), [medy@cs.aau.dk](mailto:medy@cs.aau.dk)): library developer;
...
- Martin Hruška ([martinhruska](https://github.com/martinhruska), [ihruska@fit.vut.cz](mailto:ihruska@fit.vut.cz)): former library design advisor and library developer;
- Tomáš Fiedor ([tfiedor](https://github.com/tfiedor), [ifiedortom@fit.vut.cz](mailto:ifiedortom@fit.vut.cz)): former python binding maintainer;
