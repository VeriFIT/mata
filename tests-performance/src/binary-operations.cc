...
int load_automaton(std::string filename, Nfa& aut, std::unordered_map<std::string, Mata::Symbol>& stsm, std::string aut_name) {
...
int main(int argc, char *argv[])
{
    ...
    Nfa lhs;
    Nfa rhs;
    std::unordered_map<std::string, Mata::Symbol> lhs_stsm;
    std::unordered_map<std::string, Mata::Symbol> rhs_stsm;
